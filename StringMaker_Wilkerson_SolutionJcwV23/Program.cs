// Jonathan Wilkerson
// IT113
// NOTES: This C# program includes a StringManager class that provides string manipulation methods, including reversing strings with and without preserving casing, checking string symmetry, converting a string to words, and checking string equality.
...
public class Program
{
    ...
    {
        // Test cases
        StringManager stringManager = new StringManager("Gazoontite");



        Console.WriteLine("1. Reverse a string: " + stringManager.Reverse("Gazoontite"));
        Console.WriteLine("2. ToString: " + stringManager.ToString());
        Console.WriteLine("3. Reverse a string with preserved casing: " + stringManager.Reverse("Gazoontite", true));
        Console.WriteLine("4. Equality Check: " + stringManager.Equals("Gazoontite"));
